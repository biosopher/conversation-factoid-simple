...
var ConversationPanel = (function() {
    ...
    function init() {
        chatUpdateSetup();
        submitUserQuery("") // Init conversation
        setupInputBox();

        var exampleQuestionUX;
        // Initialize Example Questions
        exampleQuestionUX = new ExampleQuestionUX(submitUserQuery);
    }
...
// Set up the input box to underline text as it is typed
    ...
    function displayMessage(newPayload, typeValue) {
        var isUser = typeValue === settings.authorTypes.user
    ...
    function inputKeyDown(event, inputBox) {
        ...
        if (event.keyCode === 13 && inputBox.value) {
            ...
            submitUserQuery(inputBox.value)
        }
    }
}());
